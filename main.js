...
const lines = [];
let linesMaterials = [
  new THREE.LineBasicMaterial({ transparent: true, color: 0x00FFFF }),
  new THREE.LineBasicMaterial({ transparent: true, color: 0xf9fbf2 })
];
let galaxyColors = [
  new THREE.Color("#f9fbf2").multiplyScalar(0.8),
  new THREE.Color("#ffede1").multiplyScalar(0.8),
  new THREE.Color("#00FFFF").multiplyScalar(0.8),
  new THREE.Color("#99FFFF").multiplyScalar(0.8),
  new THREE.Color("#00CCFF").multiplyScalar(0.8)
];
function dots() {
...
loader.load(
  ...
  (obj) => {
    ...
    whale.geometry.translate(0, -1, 0);
